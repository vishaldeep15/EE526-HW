...
\begin{equation}
	p^{[0]} = \begin{bmatrix}
				\frac{e^{0}}{e^{0}+e^{0}+e^{0}+e^{0}} & \frac{e^{0}}{e^{0}+e^{0}+e^{0}+e^{0}} \\
				\frac{e^{0}}{e^{0}+e^{0}+e^{0}+e^{0}} & \frac{e^{0}}{e^{0}+e^{0}+e^{0}+e^{0}} 
	    	  \end{bmatrix} = 
	    	  \begin{bmatrix}
				0.25 & 0.25 \\
...
\begin{align*}
	J^{[0]} = - \sum_{i=1}^{4}y_{i}\log{p_{i}} = - \boldsymbol{y}(\boldsymbol{\log{p}})^{T}
\end{align*}
...
\begin{equation}
	\boldsymbol{dz}^{[0]} = \boldsymbol{p} - \boldsymbol{y}	= 
				\begin{bmatrix}
				0.25 & 0.25 \\
				0.25 & 0.25 
	    	  \end{bmatrix}	- 
...
\begin{equation}
	p^{[1]} = \frac{e^{z_i}}{\sum_{i=1}^{4}e^{z_i}} = 
	    	  \begin{bmatrix}
				0.365 & 0.134 \\
				0.134 & 0.365
	    	  \end{bmatrix}	
...
\begin{align*}
	J^{[1]} = - \sum_{i=1}^{4}y_{i}\log{p_{i}} = - \boldsymbol{y}(\boldsymbol{\log{p}})^{T}
\end{align*}
...
Now doing back propagation, from \cref{eqn:dz}
\begin{equation}
	\boldsymbol{dz}^{[1]} = \boldsymbol{p} - \boldsymbol{y}	= 
				\begin{bmatrix}
				0.365 & 0.134 \\
				0.134 & 0.365
	    	  \end{bmatrix}		- 
