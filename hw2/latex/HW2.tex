...
\begin{equation}
	p^{[0]} = \begin{bmatrix}
				\frac{e^{0}}{e^{0}+e^{0}} & \frac{e^{0}}{e^{0}+e^{0}} \\
				\frac{e^{0}}{e^{0}+e^{0}} & \frac{e^{0}}{e^{0}+e^{0}} 
	    	  \end{bmatrix} = 
	    	  \begin{bmatrix}
				0.5 & 0.5 \\
...
\begin{equation}
	J^{[0]}  = - \sum_{i=1}^{2}
				...
				\log{0.5} & 0 \\
				0 & \log{0.5} 
	    	  \end{bmatrix} \approx 0.6931
\end{equation}

Now doing back propagation, from \cref{eqn:dz}
\begin{equation}
	\boldsymbol{dz}^{[0]} = \frac{1}{m}(\boldsymbol{p} - \boldsymbol{y}) = 
				\frac{1}{2}				
				\begin{bmatrix}
				0.5 & 0.5 \\
				0.5 & 0.5 
...
\begin{equation}
	\boldsymbol{dW}^{[0]} = \boldsymbol{dz^{[0]}} \boldsymbol{X^{T}}	= 
			\begin{bmatrix}
				-0.25 & 0.25 \\
				0.25 & -0.25 
	    	  \end{bmatrix}	
...
\begin{equation}
	\boldsymbol{db}^{[0]} = \boldsymbol{dz^{[0]}} \begin{bmatrix}
				1 \\
				1 
	    	  \end{bmatrix}	= 	    	  
	    	  \begin{bmatrix}
...
\begin{equation}
	\boldsymbol{W}^{[1]} = \boldsymbol{W^{[0]}} - 1. \boldsymbol{dW^{[0]}} =
		\begin{bmatrix}
		0 & 0 \\
		0 & 0 
	    \end{bmatrix} - 
...
\begin{equation}
	\boldsymbol{b}^{[1]} = \boldsymbol{b^{[0]}} - 1. \boldsymbol{db^{[0]}} =
	 \begin{bmatrix}
		0 \\
		0 
	 \end{bmatrix} - 
...
\begin{equation}
	p^{[1]} = \frac{e^{z_i}}{\sum_{i=1}^{2}e^{z_i}} = 
				\begin{bmatrix}
				\frac{e^{0.25}}{e^{0.25}+e^{-0.25}} & \frac{e^{-0.25}}{e^{0.25}+e^{-0.25}} \\
				\frac{e^{-0.25}}{e^{0.25}+e^{-0.25}} & \frac{e^{0.25}}{e^{0.25}+e^{-0.25}} 
	    	  \end{bmatrix} = 
	    	  \begin{bmatrix}
				0.62 & 0.38 \\
...
\begin{equation}
	J^{[1]} = - \sum_{i=1}^{2}
			  \begin{bmatrix}
				\log{0.62} & 0 \\
				0 & \log{0.62} 
	    	  \end{bmatrix}	\approx 0.4741	    
\end{equation}

Now doing back propagation, from \cref{eqn:dz}
\begin{equation}
	\boldsymbol{dz}^{[1]} = \frac{1}{m}(\boldsymbol{p} - \boldsymbol{y}) = 
				\frac{1}{2}				
				\begin{bmatrix}
				0.62 & 0.38 \\
				0.38 & 0.62 
...
\begin{equation}
	\boldsymbol{dW}^{[1]} = \boldsymbol{dz^{[1]}} \boldsymbol{X^{T}}	= 
			\begin{bmatrix}
				-0.19 & 0.19 \\
				0.19 & -0.19 
	    	  \end{bmatrix}	
...
\begin{equation}
	\boldsymbol{db}^{[1]} = \boldsymbol{dz^{[1]}} \begin{bmatrix}
				1 \\
				1 
	    	  \end{bmatrix}	= 	    	  
	    	  \begin{bmatrix}
...
Now update weights and bias matrices with learning rate = 1,
\begin{equation}
	\boldsymbol{W}^{[2]} = \boldsymbol{W^{[1]}} - 1. \boldsymbol{dW^{[1]}} =
  		\begin{bmatrix}
		0.25 & -0.25 \\
		-0.25 & 0.25
	   	\end{bmatrix}	- 
...
\begin{equation}
	\boldsymbol{b}^{[2]} = \boldsymbol{b^{[1]}} - 1. \boldsymbol{db^{[1]}} =
	 \begin{bmatrix}
		0 \\
		0
	  \end{bmatrix}  - 
...
\inputpython{pythonfiles/problem5.py}{1}{103}
...
\inputpython{pythonfiles/problem6.py}{1}{157}
